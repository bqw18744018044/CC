...
"""
Author: Qiangwei Bai
Date: 2022-04-10 13:55:14
LastEditTime: 2022-04-10 13:55:15
LastEditors: Qiangwei Bai
FilePath: /CC/trainer.py
Description: 
"""
import sys
import torch
...
class CCTrainer():
    ...
    def train(self):
        ...
        sccl = CC(backbone=backbone, num_classes=self.args.num_classes, batch_size=self.args.train_batch_size)
        ...
        optimizer = torch.optim.Adam([
            {'params':sccl.backbone.parameters()}, 
            {'params':sccl.instance_head.parameters(), 'lr': self.args.learning_rate},
            {'params':sccl.cluster_head.parameters(), 'lr': self.args.learning_rate}
...
def get_args(argv):
    ...
    parser.add_argument("--backbone", type=str, default="E:/pretrained/bert-base-uncased")
    parser.add_argument("--dts_name", type=str, default="SearchSnippets")
